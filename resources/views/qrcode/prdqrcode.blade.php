...
<div class="box">
    ...
    <div class="box-body">
        {{Form::open(array('url'=>'qrcode/save','method'=>'post','id'=>'qr_form','enctype'=>'multipart/form-data'))}}
      <div class="row">
...
<!--               <div class="form-group col-sm-6">
 -->             <div class="form-group col-sm-2 ">
                  <button type="submit" id="add" class="btn btn-primary" onclick="printBtnClick()"><i class="fa fa-hdd-o"></i> Print</button>
                </div>
                 <div class="form-group col-sm-2">
