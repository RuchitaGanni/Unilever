...
{{Form::open(array('url' => 'package/packagestore'))}}
 {{ Form::hidden('_method', 'POST') }}
<h2 style="color:Brown">Package Details</h2>
<fieldset>
<legend>package details</legend>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="6">
    <tbody>
        ...
        <tr>
                <td>Package Name :</td>
                <td>:</td>
                <td><input type='text'  name='package_name' id='package_name' value='' class='input1 required'></td>
                <td width="10"></td>
  ...
  <tr>
                <td>Weight :</td>
                <td>:</td>
                <td><input type='text'  name='weight' id='weight' value='' min="1" class='input1 decimal'></td>
                <td width="10"></td>
                <!-- <td>Validation Message</td> -->
              </tr>
      ...
      <fieldset>
        ...
        <center>
         ...
         <tr>
                <td>Length</td>
                <td>:</td>
                <td><input type='text'  name='package_length' id='package_length' value='' class='input1 decimal'></td>
                <td width="10"></td>
                <!-- <td>Validation Message</td> -->
              </tr>
         ...
         <tr>
                <td>Width</td>
                <td>:</td>
                <td><input type='text'  name='package_width' id='package_width' value='' class='input1 decimal'></td>
                <td width="10"></td>
                <!-- <td>Validation Message</td> -->
              </tr>
        ...
        <tr>
                <td>Height</td>
                <td>:</td>
                <td><input type='text'  name='package_height' id='package_height' value='' class='input1 decimal'></td>
                <td width="10"></td>
                <!-- <td>Validation Message</td> -->
              </tr>
   ...
   <div> {{ Form::submit('CREATE', array('class' => 'btn btn-primary')) }}
{{ Form::close() }}
</div>
 </div>
    </div>
