...
<!--                           <small>Member since Nov. 2014</small>
 -->                        </p>
                  ...
                  <li class="dropdown messages-menu">
                    ...
                    <a href="javascript:void(0);" class="navbar-brand" id="toggle_modal"><i class="fa fa-map-marker" aria-hidden="true" style="padding-right:2px;"></i>{{Session::get('user_cur_loca_name')}}</a>
                  </li>
                </ul>
              </div>
            </nav>
