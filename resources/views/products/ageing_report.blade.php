...
<?php } ?>
    <form id="igGenForm">
        ...
        <div class="box-header">
          <h3 class="box-title"><i class="fa fa-th"></i><strong> Product Ageing </strong>Report</h3>
        </div>
        ...
        <tbody>
          <?php
            foreach ($dataArray['data'] as $key => $value) {
              echo "<tr class='location'><td colspan='6'>".$dataArray['locations'][$key]."</td></tr>";
              foreach ($value as $pid => $item) {
                  echo "<tr>
                        <td>".$dataArray['mat_name'][$pid]."-".$dataArray['mat_code'][$pid]."</td>
                        <td>".$item['100p']."</td>
                        <td>".$item['80p']."</td>
                        <td>".$item['60p']."</td>
                        <td>".$item['40p']."</td>
