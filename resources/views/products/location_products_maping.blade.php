...
<script src="http://cdn.rawgit.com/davidstutz/bootstrap-multiselect/master/dist/js/bootstrap-multiselect.js"
    ...
    @endif
                ...
                <div class="input-group ">
                    ...
                    <div id="selectbox">
                        <select class="list-unstyled selectpicker" data-live-search="true"  required="required" id="location_type" name="location_type"
                ...
                <div class="input-group ">
                    <span class="input-group-addon addon-red"><i class="fa fa-user"></i></span>
                    <div id="selectbox">
                        <select class="" multiple="multiple" id="location_id" name="location_id[]" required="required" onchange = "changeStorageLocations()">
                ...
                <div class="input-group ">
                    <span class="input-group-addon addon-red"><i class="fa fa-user"></i></span>
                    <div id="selectbox">
                        <select class="" required="required" id="product_group" name="product_group[]"
                                   onchange="changeProducts();" required="required">
                ...
                <div class="input-group ">
                    <span class="input-group-addon addon-red"><i class="fa fa-user"></i></span>
                    <div id="selectbox">
                        <select class=""  required="required" id="product_id" name="product_id[]"  multiple="multiple">
                ...
                <div class="col-sm-6 pull-right">
                    ...
                    <button type="submit"  id="Search" name="Search"class="gridrefresh btn btn-primary" >Search</button>
    ...
    <form method="post" action="/products/mapProduct" id="mapProductloc">
        <div class="modal" id="maplocation">
            <div class="modal-dialog" >
                <div class="modal-content">
                    <div class="modal-header">
                        <button tybnope="button" class="close" data-dismiss="modal">&times;</button>
...
// $("#location_id").multiselect('clearSelection', true);
// $("#product_id").multiselect('clearSelection', true);
...
// // $('#location_id').get(0).selectedIndex = -1;
//     });
$('#prod_id').multiselect({
...
$("form").submit(function() { 
                    $('#product_id').multiselect('clearSelection', true);
                    $('#location_id').multiselect('clearSelection', true);
                    $('#product_group').multiselect('clearSelection', true);
                    // $('#location_type').dropdown('clearSelection',true);
                     // $("#location_type").selectedIndex = 0;
                     var dropDown = document.getElementById("location_type");
