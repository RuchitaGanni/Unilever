...
<div><span class="error_message">{{ $formData['error_message'] }}</span></div>
    {{ Form::open(array('url' => 'products/savelocationtypefromexcel', 'method' => 'POST', 'files'=>true, 'id' => 'customer_onboard_update')) }}
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs pull-right">
            ...
            <li class="pull-left header"><i class="fa fa-th"></i> Edit Location</li>
        </ul>                
    </div>
        ...
        <div class="tab-pane" id="location_types">
            ...
            <div class="row">
                ...
                <div class="form-group pull-left" style="margin-left:15px;">
                    ...
                    <a href="{{ url('products/exportTo/xls') }}" > 
        ...
        <div class="modal-dialog wide">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ Form::open(array('url' => '/products/savelocationtypefromexcel', 'id' => 'add_locationtypes_form_excel', 'files'=>'true' )) }}
                    {{ Form::hidden('_method','POST') }}

                    <div class="form-group ">
                            <!--<label class="col-sm-2 control-label"></label>-->
                      <div class="col-xs-6 col-sm-4"> <a href="/products/download/Locations"  style="margin-top:0px;"><i class="fa fa-download"></i> Download sample file </a></div>
        ...
        <div class="modal fade" id="location_types_add" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/prodcuts/savelocationtype', 'data-url' => '/prodcuts/savelocationtype/','id' => 'add_locationtypes_form' )) }}
                        {{ Form::hidden('_method','POST') }}
        ...
        <div class="modal fade" id="location_types_edit" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/products/updatelocationType/', 'data-url' => '/products/updatelocationType/','id' => 'edit_locationtypes_form' )) }}
                        {{ Form::hidden('_method','POST') }}
                        <input type="hidden" id="manufacturer_id" value="{{ $customer_id }}"/>
                        <div class="row">
                            <div class="form-group col-sm-6">
        ...
        <div class="modal-dialog wide">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    {{ Form::open(array('url' => '/products/importfromerp', 'id' => 'add_products_form_erp' )) }}
                    {{ Form::hidden('_method','POST') }}
                    <div class="row">
        ...
        <div class="modal fade" id="basicvalCodeModal" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/products/savelocation', 'data-url' => '/products/savelocation/', 'id' => 'add_location_form' )) }}
                        {{ Form::hidden('_method','POST') }}
        ...
        <div class="modal fade" id="basicvalCodeModal1" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/products/updatelocation','data-url' => '/products/updatelocation/', 'id' => 'edit_location_form')) }}
...
<script type="text/javascript">
    ...
    function loadProducts()
    {
        var customerId = $('[name="customer_id"]').val();
        var baseUrl = '{{ URL::to('/') }}';
        var url = baseUrl + "/products/getproducts?customerId=" + customerId;
        // prepare the data
        var source =
                {
                    datatype: "json",
    ...
    function deleteLocation(location_id,manufacturerId)
    {
        ...
        if ( dec == true )
            $.ajax({
                url: 'products/deletelocation/' + location_id,
                type:'GET',
                success: function(result)
                {
    ...
    function restoreLocation(location_id,manufacturerId)
    {
        ...
        if ( dec == true )
            $.ajax({
                url: 'products/restorelocation/' + location_id,
                type:'GET',
                success: function(result)
                {
    ...
    function restoreLocationType(location_type_id,manufacturerId)
    {
        ...
        if ( dec == true )
            $.ajax({
                url: 'products/restorelocationtype/' + location_type_id,
                type:'GET',
                success: function(result)
                {
    ...
    function deleteLocationType(location_type_id,manufacturerId)
    {
        ...
        $('#verifyUserPassword button#save-btn').on('click',function(e){
            ...
            $.ajax({
                url: 'products/deletelocationtype/' + location_type_id,
...
$('#update_location_type_id').change(function(){
    ...
    url = '/products/getlocationsbytype';
...
$('#add_products_form_excel').submit(function(event){
    ...
    //                 alert(data);
    //             /*alert(data);
    //             $('#update_import_locations_message').text(resp.msg);
    //             alert(resp.msg);         
    //             if(resp.msg.indexOf('Successfully')>=0)
    //                 $('.close').trigger('click');
    //             var optionData = '';*/
