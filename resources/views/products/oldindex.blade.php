...
<div class="box">
    <div class="box-header">
      ...
      <?php if(isset($allow_buttons['add']) && $allow_buttons['add'] == 1){ ?>
        <button class="btn btn-primary pull-right" data-toggle="modal" onclick="location.href = '/product/create';">Add New Product</button>
      <?php } ?>

      
      
                <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#products_add_excel"> 
    ...
    <form action="products/exportxls" method="post" id="exportxls">
                           ...
                           <!--  <div class="col-sm-10"> -->
                                ...
                                <div class=" col-sm-4"> <a href="/customer/download/FG_Material_Codes" class="btn bg-orange margin" style="margin-top:0px;"><i class="icon-download-alt"> </i> Download sample file </a>
                                 ...
                                 <div>
                                    ...
                                    <input type="hidden" name="manufacturerID" value="{{$customer}}"/>
                                    </div>
                                 </div>  
            ...
            $("#jqxgrid").jqxGrid(
                    {
                        ...
                        filterable: true,
                         // autoRowHeight : true,   
                            ...
                            {text: 'Product Name', datafield: 'name', width: "20%"},
