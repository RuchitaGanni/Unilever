...
<div align="center" id="loading" style="text-align:center; z-index:9999;position:absolute;background:rgba(0,0,0,0.3);height:709px; width:1261px; display:none;" ><img src="/img/loading.gif">    </div>
    ...
    <div class="box">      
        <div class="main" style="margin-top:15px;">           
            ...
            <div class="form-group col-sm-7">
              <div class="form-group pull-right">
                <div class="col-sm-10">
                    @if($sto)
               <a href="/deliveries/add" class="button"> <button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i><span style="font-size:11px;"> Create STO</span></button></a>
                  @endif
            </div>
            </div>
           </div> 
        ...
        <div class="modal fade" id="stogrid" tabindex="-1" role="dialog"  aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    <div class="modal-header ">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="basicvalCode"><strong>Deliveries  of  STO : <span class="delivery_no"></span></strong> </h4>
                    </div>
                    <div class="modal-body">
                        <div id="del_grid"></div>
...
/*
    ...
    var url = "/delivery/getElementdata/0/"+id;
  //  "/delivery/getDeliveries/"+id;
    ...
    $.get(url,function(response){
        ...
        //alert(res);
        console.log(response['masterData']);
        ...
        var df=[
                ...
                { name: 'SrcLoc', type: 'string' },
                { name: 'StorLoc', type: 'string' },
                { name: 'shipment_no', type: 'string' },
                { name: 'to_no', type: 'string' },
                { name: 'date', type: 'string' } ,
                { name: 'status', type: 'string' },
                { name: 'tpUrl', type: 'string' }
            ];
        var clms=[
                { text: 'Document No', datafield: 'document_no', filtertype: 'input', width:'10%'},
                { text: 'Receiving Plant', datafield: 'DestLoc', filtertype: 'input', width:'15%'},
                { text: 'Supplier Plant', datafield: 'SrcLoc', filtertype: 'input', width:'15%'},
                { text: 'Storage Loc', datafield: 'StorLoc', filtertype: 'input', width:'10%'},
                { text: 'Shipment', datafield: 'shipment_no', filtertype: 'input', width:'12%'},
                { text: 'TO number', datafield: 'to_no', filtertype: 'input', width:'10%'},
                { text: 'Status', datafield: 'status', filtertype: 'input', width:'10%'},
                { text: 'Date', datafield: 'date', filtertype: 'input', width:'16%'},
                { text: 'Invoice', datafield: 'tpUrl', filtertype: 'input', width:'10%'}
                           ];
          ...
          //  alert('before hell2');
            ...
            if (grid != null) {
                grid.jqxGrid({
                    ...
                    selectionmode: 'multiplecellsextended', 
                    columns: [
                      { text: 'Product Name', datafield: 'PName', filtertype:'input', width: 250 },
                      { text: 'Line No', datafield: 'lineNo',width: 100 },
                      { text: 'Qty', datafield: 'Qty', width: 120},
                      { text: 'Batch No', datafield: 'batch_no', width: 120}                     
...
//alert('hell4');
     ...
     function getgrid_old(id){
    $('#stogrid').modal('toggle');
       var  url="/delivery/getDeliveries/"+id;
       //$.get(url,function(response){
        // var res = response['masterData'];
        //alert(res);
        // var res1 = response['detailsData'];
        var source_del =
          {
            ...
            var dataAdapter = new $.jqx.dataAdapter(source_del);
                
                createGrid(dataAdapter);

            }
                var columns_del=[
                      // { text: 'STO No', datafield: 'DeliveryId', filtertype: 'input', width:'12.5%'},
                { text: 'Reference No', datafield: 'document_no', filtertype: 'input', width:'12.5%'},
                // { text: 'Type', datafield: 'name', filtertype: 'input', width:'12.5%'},
                { text: 'Receiving Plant', datafield: 'DestLoc', filtertype: 'input', width:'12.5%'},
                { text: 'Supplier Plant', datafield: 'SrcLoc', filtertype: 'input', width:'12.5%'},
                { text: 'Storage Location', datafield: 'StorLoc', filtertype: 'input', width:'12.5%'},
                { text: 'Status', datafield:'remarks', filtertype: 'input', width:'12.5%'},
                { text: 'Date', datafield: 'date', filtertype: 'input', width:'12.5%'}
                      ];

            
                  
                  
function createGrid(source_del)  
{
  $("#del_grid").jqxGrid({
...
$("#del_grid").on('keydown', function (event) {
      const originalEvent = event.originalEvent;

      if (originalEvent.ctrlKey && originalEvent.key == "c"){
        var cell = $('#del_grid').jqxGrid('getselectedcell');                    
        console.log(cell)
      }
    });
...
//validator
    ...
    $.get(url,function(response){
        ...
        var clms=[
                { text: 'STO No', datafield: 'DeliveryId', filtertype: 'input', width:'10%'},
                { text: 'Reference No', datafield: 'document_no', filtertype: 'input', width:'10%'},
                { text: 'Shipment No', datafield: 'shipment_no', filtertype: 'input', width:'10%'},
                { text: 'Type', datafield: 'name', filtertype: 'input', width:'5%'},
                { text: 'Receiving Plant', datafield: 'DestLoc', filtertype: 'input', width:'10%'},
                { text: 'Supplier Plant', datafield: 'SrcLoc', filtertype: 'input', width:'10%'},
                { text: 'Storage Location', datafield: 'StorLoc', filtertype: 'input', width:'10%'},
                { text: 'Status', datafield: 'remarks', filtertype: 'input', width:'20%'},
                { text: 'Date', datafield: 'date', filtertype: 'input', width:'15%'}
              ];
            if(!sto){
              df=[
                { name: 'document_no', type: 'string' },
        ...
        clms=[
                ...
                { text: 'Receiving Plant', datafield: 'DestLoc', filtertype: 'input', width:'20%'},
                { text: 'Supplier Plant', datafield: 'SrcLoc', filtertype: 'input', width:'20%'},
            ...
            if (grid != null) {
                grid.jqxGrid({
                    ...
                    columns: [
                      ...
                      { text: 'Line No', datafield: 'lineNo',width: 70 },
                      { text: 'Qty', datafield: 'Qty', width: 70},                     
                      { text: 'Batch no.', datafield: 'batch', width: 140},                     
                      { text: 'Actions', datafield: 'actions',  width:100}
