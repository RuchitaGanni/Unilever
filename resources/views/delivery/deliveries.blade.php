...
//alert('hell3');
        $("#Attributegrid").jqxGrid(
        {
            ...
            initrowdetails: initrowdetails,
                    columns: [
                { text: 'Document No', datafield: 'document_no', filtertype: 'input', width:300},
                { text: 'Sto No', datafield: 'DeliveryId', filtertype: 'input', width:257},
                { text: 'Type', datafield: 'name', filtertype: 'input', width:150},
                { text: 'Destination Location', datafield: 'DestLoc', filtertype: 'input', width:300},
                { text: 'Date', datafield: 'date', filtertype: 'input', width:300}
        ...
        <div class="main" style="margin-top:15px;">           
            <div class="row">
              ...
              <div class="form-group">
                <div class="col-sm-10">
              <p style="font-size:20px">Delivery Details</p>
            </div>
            </div>
           </div> 
            ...
            <div class="form-group col-sm-7">
              <div class="form-group pull-right">
                <div class="col-sm-10">
               <a href="/delivery/add" class="button"> <button type="button" class="btn btn-success"><i class="fa fa-plus-circle"></i><span style="font-size:11px;">Create Delivery</span></button></a>
            </div>
            </div>
           </div> 
            </div> 
