...
<div>
  <span class="error_message"></span></div>
    ...
    <div class="box-header">
      <a href="#erp_configuration"><h3 class="box-title"><strong>ERP </strong>Configuration</h3></a>
      </div>
    <!-- tile body -->
    <div class="col-sm-12">
       <div class="tile-body nopadding">                 
         <div class="tab-pane" id="erp_configuration">
            <div class="">
                {{ Form::open(array('url' => '/erp/saveerpconfigurations', 'id' => 'erp_configurations_form' )) }}
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="web_service_url" id="web_service_url" class="form-control" required="true" value="{{$customerErpConfiguration->web_service_url}}" />
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="token" id="token" class="form-control" required="true" value="{{$customerErpConfiguration->token}}" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="company_code" id="company_code" class="form-control" required="true" value="{{$customerErpConfiguration->company_code}}" />
                        </div>
                    </div>
                    <!-- <div class="form-group col-sm-6">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="web_service_username" id="web_service_username" class="form-control" required="true" value="{{$customerErpConfiguration->web_service_username}}" />
                        </div>
                    </div>
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="web_service_password" id="web_service_password" class="form-control" required="true" value="{{$customerErpConfiguration->web_service_password}}" />
                        </div>
                    </div>
                </div>
