...
//validator
    ...
    //alert('adfadffsadfsad');
     $(document).ready(function () {
      ...
      function isIdle() {
        ...
        window.location.assign("http://vguard.esealinc.com:555");
      }
});
    ...
    var manufacturerId = $('#main_manufacturer_id').val();  
        $('#manuId').hide();               
    var url = "/vendorinvoice/getElementdata";
    $("#loading").show();
          ...
          //  alert('before hell2');
            ...
            if (grid != null) {
                grid.jqxGrid({
                    ...
                    sortable: true,    
                    columns: [
                      { text: 'Product Name', datafield: 'product_name', filtertype:'input', width: 270 },
...
//alert('hell3');
        $("#Attributegrid").jqxGrid(
        {
            ...
            initrowdetails: initrowdetails,
                    columns: [
                { text: 'PO No', datafield: 'po_number', filtertype: 'input', width:200},
                { text: 'Invoice No', datafield: 'invoice_number', filtertype: 'input', width:250},
                { text: 'Invoice Date', datafield: 'invoice_date', filtertype: 'input', width:260},
            { text: 'Bill No', datafield: 'bill_number', filtertype: 'input', width:250},
                { text: 'Bill Date', datafield: 'bill_date', filtertype: 'input', width:250}
            // { text: 'Status', datafield: 'status', filtertype: 'input', width:100}
...
<div align="center" id="loading" style="text-align:center; z-index:9999;position:absolute;background:rgba(0,0,0,0.3);height:709px; width:1261px; display:none;" ><img src="/img/loading.gif">    </div>
        ...
        <div class="main" style="margin-top:15px;">           
            <div class="row">
              ...
              <div class="form-group">
                <div class="col-sm-10">
              <p style="font-size:20px">Vendor Invoice Details</p>
            </div>
            </div>
           </div> 
            ...
            <div class="form-group col-sm-7">
              <div class="form-group ">
               ...
               <a href="/vendorinvoice/add" class="button"> <button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;<span style="font-size:11px;">Create Invoice</span></button></a>
            </div>
            <div class="col-sm-2 pull-right">
             <button type="button" class="btn btn-primary" onclick="Export()"><i class="fa fa-plus-circle"></i>&nbsp;<span style="font-size:11px;">Export</span></button>
                </div>
            </div>
           </div> 
            </div> 
    ...
    <script type="text/javascript">
        ...
        function Export(){
            //alert('heke');
            var url = "/vendorinvoice/exportExcel";
             window.location = url;         
