...
<div><span class="error_message"></span></div>
    ...
    <!-- <div >
        ...
        <li class="pull-left header"><a href="#location_types"><i class="fa fa-th"></i><h3> Location Types</h3></a></li>
        </ul>                
    </div> -->
     <div class="box-header">
      <a href="#location_types"><h3 class="box-title"><strong>Location Types </strong></h3></a>
  ...
  <div class="form-group col-sm-5">
      ...
      <div id="selectbox">
       <select class="form-control requiredDropdown" id="customer_id" name="customer_id"       parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox" onchange="getlocationtypes($(this).val())" >
    ...
    @endif
    <div class="form-group col-sm-5">
      <label for="exampleInputEmail">Choose Location Type</label>
        <div id="selectbox">
  {{ Form::open(array('url' => '/locationtypes/getTreeLocation/{manufacturer_id}','method'=>'POST','id'=>'pay','role'=>"form",'name'=>'pay')) }}
        <select class="form-control requiredDropdown" id="locationtypes"    parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox" onchange="ajaxLocationCall($(this).val())" >
          <option  value="">Select Location </option>
            @foreach($locas as $id=>$loc)  
    ...
    <div class="col-sm-12">
       <div class="tile-body nopadding">
        ...
        <div  id="location_types">
            ...
            <div class="row">
                <input type="hidden" readonly id="manufid" name="manufid" value="{{$customer_id}}" />
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-xs-6 col-sm-5">
                               <!--  <span class="btn btn-success fileinput-button">
                                    ...
                                    <input type="hidden" name="manufacturerID" value="{{$customer_id}}"/>      
                             </div> 
                     <div class="col-xs-6 col-sm-3"> {{ Form::submit('Upload File', array('class' => 'btn btn-primary', 'id' => 'add_locationtypes_excel_button')) }} 
<!--                      <button id="add_locationtypes_excel_button" type="submit">Upload File</button>
 -->
                    {{ Form::close() }}</div>
                    </div>
                   <br><br>
            ...
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="manufacturer_id" value="5"/>
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="exampleInputEmail">Location Type Name</label>
                                <div class="input-group input-group-sm">
            ...
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{ Form::hidden('_method','POST') }}
                        <input type="hidden" name="manufacturer_id" value="{{ $customer_id }}" />
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <div class="checkbox">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="hidden" id="location_type_manufacturer_id" value="{{ $customer_id }}" />
                                </div>                                            
                            </div>
                        </div>
                        <div class="row">
        ...
        <div class="modal fade" id="basicvalCodeModal" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/locationtypes/savelocation', 'data-url' => '/locationtypes/savelocation/', 'id' => 'add_location_form' )) }}
                        {{ Form::hidden('_method','POST') }}
                        <input type="hidden" name="manufacturer_id" id="manufacturer_id" value="5" />
                        <div class="row">
                            <div class="form-group col-sm-6">
                              ...
                              <label for="country">Country*</label>
                                <div class="input-group input-group-sm">
                                  <span class="input-group-addon addon-red"><i class="ion-earth"></i></span>
                                     <div id="selectbox">
                                        <select class="chosen-select form-control parsley-validated"  data-live-search="true" name="country" parsley-trigger="change" id="location_country_id" parsley-required="true" parsley-error-container="#selectbox">
        ...
        <div class="modal fade" id="basicvalCodeModal1" tabindex="-1" role="dialog" aria-labelledby="basicvalCode" aria-hidden="true">
            <div class="modal-dialog wide">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{ Form::open(array('url' => '/locationtypes/updatelocation','data-url' => '/customer/updatelocation/', 'id' => 'edit_location_form')) }}
                        {{ Form::hidden('_method','PUT') }}
                        <input type="hidden" name="manufacturer_id" id="manufacturer_id" value="5" />
                        <div class="row">
                            <div class="form-group col-sm-6">
                         ...
                         <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-addon addon-red"><i class="ion-earth"></i></span>
                                    <div id="selectbox">
                                        <select class="chosen-select form-control parsley-validated" data-live-search="true" name="country" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox">
                                           <option value="0"> Select Country</option>
                                            @foreach ($formData['countries'] as $key => $value)
                                                <option value="{{ $key }}">{{ $value }}</option>
                                            @endforeach
            ...
            fields: {
                location_type_name: {
                    validators: {
                        ...
                        regexp: {
                             regexp: /^[a-zA-Z-\s]+$/i,
                            message: 'The Locationtype Name can consist of alphabetical characters and spaces only'
                        },
                    remote: {
 ...
 function isValidDate(dateVal)
{
    ...
    function ajaxCall(countryId, stateId, isMultiselect, isKey)
    {
        ...
        $.get('/locationtypes/getZones?countryId=' + countryId, function (data) {
...
<script type="text/javascript">
    ...
    function ajaxLocationCall( loc_type=0)
    {
                        ...
                        var source =
                                {
                                    ...
                                    id: 'location_id',
                                    url: "/locationtypes/getTreeLocation/" + customerId+'?location_type_id='+loc_type,
                                    //localData: employees,
                        ...
                        $("#locations_treegrid").jqxTreeGrid(
                                {
                                    ...
                                    //filterable:true,
                                     ready: function () {
                                   $("#locations_treegrid").jqxTreeGrid('expandRow', '2');
                                      },
...
function getlocationtypes(cust = 0){
                    $.ajax({
                    url: '/locationtypes/locationtypes/'+cust,
                    //type: 'POST',
                    //async: false,
                    success: function (data) {                    
                        if(data)
