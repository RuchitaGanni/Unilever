...
{{ Form::model($uomgroup, array('route' => array('uomgroup.update', $uomgroup->id), 'method' => 'PUT')) }}
<fieldset>
<legend>Edit {{ $uomgroup->description }}</legend>
...
<br>
    {{ Form::submit('Update the Uom Group!', array('class' => 'btn btn-primary')) }}
