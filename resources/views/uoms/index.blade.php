    ...
    <script type="text/javascript">
        $(document).ready(function () {           
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                filterable: true,
                columns: [
                  { text: 'Code', filtercondition: 'starts_with', datafield: 'code', width: 100 },
                  { text: 'Description', datafield: 'description', width: 100 },
                  { text: 'UOM Group', datafield: 'uom_group_id', width: 100 },
         ...
         function deleteUom(id)
        {
            ...
            if(decission==true)
                window.location.href='uoms/delete/'+id;
        }     
