...
class TransactionController extends BaseController
{
    ...
    public function index()
    {
        ...
        //dd($customer_id)
        return View::make('transaction/view')->with(['allow_buttons' => ['add' => $allowAddCustomer],'customer_id'=>$customer_id,'formData' => $formData,'manufacturer_id'=>$manuId]);
    }
    ...
    {   
        ...
        DB::table('user_tracks')->insert(array('user_id'=>Session::get('userId'),'manufacturer_id'=>Session::get('customerId'),'service_name'=>'get transactions','message'=>'Transaction Retrieved.','status'=>1,'response_duration'=>($endTime - $startTime))); 
...
/*                $cust['longitude'] = $subloc['longitude'];
    ...
    {   
        ...
        $endTime = $this->getTime();            
             ...
             $endTime = $this->getTime();            
        DB::table('user_tracks')->insert(array('user_id'=>Session::get('userId'),'manufacturer_id'=>Session::get('customerId'),'service_name'=>'add transaction','message'=>'Transaction Added.','status'=>1,'response_duration'=>($endTime - $startTime))); 
      return Response::json([
                    'status' => true,
                    'message' => 'Sucessfully added.'
        ]);
    ...
    {    
        ...
        $endTime = $this->getTime();            
        DB::table('user_tracks')->insert(array('user_id'=>Session::get('userId'),'manufacturer_id'=>Session::get('customerId'),'service_name'=>'edit transaction','message'=>'Transaction edit.','status'=>1,'response_duration'=>($endTime - $startTime))); 
    ...
    public function updateTransaction($id)
    {
        ...
        DB::table('transaction_master')
                ...
                $endTime = $this->getTime();            
        DB::table('user_tracks')->insert(array('user_id'=>Session::get('userId'),'manufacturer_id'=>Session::get('customerId'),'service_name'=>'update transaction','message'=>'Transaction updated.','status'=>1,'response_duration'=>($endTime - $startTime))); 
        return Response::json([
                    'status' => true,
                    'message' => 'Sucessfully updated.'
        ]);
        // return array('success',json_encode(array('status'=>true,'message'=>'Sucessfully Updated.'))); 
    ...
    public function deleteTransaction($id)
    {
        ...
        $endTime = $this->getTime();            
        DB::table('user_tracks')->insert(array('user_id'=>Session::get('userId'),'manufacturer_id'=>Session::get('customerId'),'service_name'=>'Delete transaction','message'=>'Transaction deleted.','status'=>1,'response_duration'=>($endTime - $startTime))); 
        return Response::json([
                    'status' => true,
                    'message' => 'Sucessfully Deleted.'
        ]);
