...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null)
    {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/uploads/customers/files/',
            'upload_url' => public_path() . '/uploads/customers/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function upcount_name($name)
    {
        ...
        //$temp = str_replace(' (', date('_Y_m_d_H_i_s'), str_replace(')', '', $temp));
        $tempName = explode('.', $temp);
        $tempExt = isset($tempName[1]) ? $tempName[1] : 'jpg';
        $temp = date('Y_m_d_H_i_s').'.'.$tempExt;
        return $temp;
    }
